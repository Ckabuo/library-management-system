...
if(isset($_REQUEST['login_btn']))
{
    ...
    $select_query = mysqli_query($conn, "select user_name, id from users_table where email='$uname' and password='$upwd' and role=2 and status=1");
    ...
    {
        $_SESSION['icon'] = "error";
        $_SESSION['text'] = "You Enter Invalid Credentials";

        // Clear POST data
        unset($uname, $password, $upwd);
...
<body class="bg-dark" style="background: url(img/library_background.jpg) no-repeat;  background-size:cover">
    <div style="background: black; position: absolute; top: 0; height: 100%; width: 100%; opacity: 0.7;"></div>
    <div class="container">
