...
$id = $_GET['id'];
$fetch_query = mysqli_query($conn, "select * from books_table where id='$id'");
...
if(isset($_REQUEST['save-book-btn']))
{
    ...
    $update_book = mysqli_query($conn,"update books_table set book_name='$book_name', category='$category_name', isbnno='$isbn', author='$author_name', publisher='$publisher_name', price='$price', quantity='$quantity', place='$location_name',  availability='$availability' where id='$id'");

    if($update_book > 0) {
        $_SESSION['icon'] = "success";
        $_SESSION['text'] = "Book Updated Successfully";

    } else {
        $_SESSION['icon'] = "error";
        $_SESSION['text'] = "Unable to Update Book";
                ...
                <form method="post" class="form-validate">
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" for="book_name">Book Name <span class="text-danger">*</span></label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" for="category_name">Category <span class="text-danger">*</span></label>
                            <div class="col-lg-6">
                                <select class="form-control" id="category_name" name="category_name" required>
                                    <option value="">Select Category</option>
                                    <?php
                                    $fetch_category = mysqli_query($conn, "select * from categories_table where status=1");
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" for="author_name">Author <span class="text-danger">*</span></label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" for="publisher_name">Publisher <span class="text-danger">*</span></label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" for="quantity">Quantity <span class="text-danger">*</span></label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-4 col-form-label" for="location_name">Location <span class="text-danger">*</span></label>
                            <div class="col-lg-6">
                                <select class="form-control" id="location_name" name="location_name" required>
                                    <option value="">Select Location</option>
                                    <?php
                                    $fetch_category = mysqli_query($conn, "select * from locations_table where status=1");
                                    while($rows = mysqli_fetch_array($fetch_category)){
                                        ?>
                                        <option <?php if($rows['name']==$row['place']){ ?>selected="selected" <?php } ?>><?php echo $rows['name'];?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
