...
if(isset($_REQUEST['login_btn']))
{
    ...
    $select_query = mysqli_query($conn,"select id, user_name from users_table where email='$email' and password='$pwd' and role = 1 and status=1");
