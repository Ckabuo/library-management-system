...
$select_book = mysqli_query($conn,"select count(*) from books_table where availability=1");
 $total_book = mysqli_fetch_row($select_book);

$issued_book = mysqli_query($conn,"select count(*) from issues_table where user_id='$id'  and status=1");
