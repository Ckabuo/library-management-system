...
if(isset($_REQUEST['sbt-book-btn']))
{
    ...
    $insert_book = mysqli_query($conn,"insert into books_table set book_name='$book_name', category='$category_name', isbnno='$isbn', author='$author_name', publisher='$publisher_name', price='$price', quantity='$quantity', place='$location_name',  availability='$availability'");

    if($insert_book > 0)
    {
        $_SESSION['icon'] = "success";
        $_SESSION['text'] = "Book Added Successfully";

    } else {

        $_SESSION['icon'] = "error";
        $_SESSION['text'] = "Book Not Added";
